...
CREATE TABLE sample_table (
       ...
       , metadata json default get_random_json()
       , label text default get_random_text()
       , dimension int default get_random_integer()
);

INSERT INTO sample_table (id) VALUES (generate_series(1, 10));
